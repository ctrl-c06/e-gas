...
<head>
    ...
    <!-- Primary Meta Tags -->
    <link rel="icon" type="image/png" sizes="16x16" href="https://surigaodelsur.ph/pds/public/assets/img/icons/favicon-16x16.png">
...
<body>
        ...
        <div class="sidebar-inner px-4 pt-3">
            <div
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="d-block">
                        <h2 class="h5 mb-3">{{ Auth::user()->firstname }} {{ Auth::user()->lastname }}</h2>
            ...
            <ul class="nav flex-column pt-3 pt-md-0">
                ...
                <li class="nav-item">
                    <a href="{{ route('fuel-slip.index') }}" class="nav-link">
                        <span class="sidebar-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <span class="sidebar-text">Fuel Slips</span>
                    </a>
                </li>
                {{-- <div class="nav-item ">
    ...
    <main class="content">
                            ...
                            <a class="nav-link dropdown-toggle pt-1 px-0" href="#" role="button"
                                ...
                                <div class="media d-flex align-items-center">
                                    ...
                                    <div class="media-body ms-2 text-dark align-items-center d-none d-lg-block">
                                        <span
                                            class="mb-0 font-small fw-bold text-gray-900">{{ Auth::user()->firstname }}
        ...
        @yield('content')
        {{-- p-5 --}}
        <footer class="bg-white rounded shadow  mb-4 mt-4">
        </footer>
    </main>

    <!-- Core -->
    <script src="{{ asset('/vendor/@popperjs/core/dist/umd/popper.min.js') }}"></script>
    <script src="{{ asset('/vendor/bootstrap/dist/js/bootstrap.min.j') }}s"></script>
    <!-- Vendor JS -->
